...
<head>
    ...
    <?php include_once (dirname(__FILE__) . '/pa_antiadblock_8569051.php'); ?>
    
    <script src="https://alwingulla.com/88/tag.min.js" data-zone="116325" async data-cfasync="false"></script> 
